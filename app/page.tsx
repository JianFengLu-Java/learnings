...
import {addToast, Avatar, Checkbox, Divider, Tab} from "@heroui/react";
                                ...
                                <div className={'w-full justify-center flex flex-col flex-1 h-full  '}>
                                    {select === "access" ? (
                                        ...
                                        <div
                                            ...
                                            <LXButton isBordered={true} size={'lg'}
                                                onPress={()=>{
                                        ...
                                        ):(<div className={'w-full justify-center items-center flex flex-col flex-1 h-full '}>
                                    <LXQRCode/>
                                </div>
                                )}
                            </div>
